...
// 5. Создание функции принимающей объект №4, и с проверкой есть ли свойство "максимальная скорость"
...
// 6. Создание функции, которая получает объект и свойство объекта, и выводит его значение
...
const phones = [ 
  { brand: "Iphone", model: "17 pro", memory: "1Tb", simCard: "1 sim", color: "orange", year: 2025},
  { brand: "Samsung", model: "galaxy S26 ultra", memory: "512Gb", simCard: "1 sim", color: "black", year: 2026},
  { brand: "Xiaomi", model: "17 pro max", memory: "512Gb", simCard: "2 sim", color: "green", year: 2025}
 ];
 phones.push({
  brand:"OnePlus",
  model:"13",
 ...
 const luxurePhones = [
  {brand: "Agent Q", model: "Silver Advanced Set", memory: "512Gb", simCard: "2 sim", color: "black", year: 1998},
  {brand: "VERTU", model: "iVERTU 5G", memory: "512Gb", simCard: "2 sim", color: "red", year: 2022}
 ];
 let allPhones = [...phones, ...luxurePhones];
